...
export const DailyIdentity = () => {
    ...
    const formatResult = (item) => {
      ...
      const icon_path = "https://raw.githubusercontent.com/jesmonn/limbusdle/refs/heads/gh-pages/images\\IdentitiesEGOArt\\"+sinner_folder+"\\Identities\\"+id_folder+"\\_gacksung_profile.png";
      return (
          <>
          <div style={
            {
