...
export const getSkillIconPath = (sinner_name, identity_name, skill_name) => {
    ...
    return "\\assets\\images\\IdentitySkillArt\\"+sinner_folder+"\\"+identity_folder+"\\"+skill_name+".png";
  }
  
export const getEgoIconPath = (sinner_name, ego_name) => {
    const sinner_folder = sinner_name.replace(/\W/g, '');
    const ego_folder = ego_name.replace(/\W/g, '');
    return "\\assets\\images\\IdentitiesEGOArt\\"+sinner_folder+"\\EGO\\"+ego_folder+"\\_awaken_profile.png";
  }
  ...
  export const getSplashIconPath = (sinner_name, id_name, rarity, normal) => {
    ...
    if (rarity === '0' || normal) {
      return "\\assets\\images\\IdentitiesEGOArt\\"+sinner_folder+"\\Identities\\"+id_folder+"\\_normal.png";
    } else {
      return "\\assets\\images\\IdentitiesEGOArt\\"+sinner_folder+"\\Identities\\"+id_folder+"\\_gacksung.png";
    }   
  }
